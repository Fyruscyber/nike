...
//
const BotName = '*Fyrus*'; // Nama Bot Whatsapp
const instagramlu = 'IndraFajri64'; // Nama Instagramlu cok
const whatsapplu = '+62 852-2608-7964'; // Nomor whatsapplu cok
const kapanbotaktif = 'TERANTUNG TUAN'; // Kapan bot lu aktif
const grupch1 =https://chat.whatsapp.com/KvnrobWpHgXEKqYwzQMTTi'; // OFFICIAL GRUP LU 1
const grupch2 = https://chat.whatsapp.com/LvnP3b4nVqo5BKrCvDj5Jh'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
